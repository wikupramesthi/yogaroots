    ...
    <div class="a1v xl:a1w">
        <div class="a1R a5 a6">
            ...
            <div class="a1S/2 a1v md:a1T/12 lg:a1T/12 xl:a1W/12">
                <div class="a1U">
                    <h3 class="a1X aE a1Y a1K a1t dark:aI">Company</h3>
                    <ul class="a1Z">
                        <li>
                            <a href="javascript:void(0)" class="aE aF aG hover:aH dark:hover:aI">Home</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="aE aF aG hover:aH dark:hover:aI">Product</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="aE aF aG hover:aH dark:hover:aI">Careers <span class="a1_ aS a16 a20 a21 aE a22 aI">Hiring</span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="aE aF aG hover:aH dark:hover:aI">Pricing</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="a1S/2 a1v md:a1T/12 lg:a1T/12 xl:a1W/12">
                <div class="a1U">
                    <h3 class="a1X aE a1Y a1K a1t dark:aI">Support</h3>
                    <ul class="a1Z">
                        <li>
                            <a href="javascript:void(0)" class="aE aF aG hover:aH dark:hover:aI">Company</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="aE aF aG hover:aH dark:hover:aI">Press media</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="aE aF aG hover:aH dark:hover:aI">Our Blog</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="aE aF aG hover:aH dark:hover:aI">Contact Us</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="a4 a1v sm:a1S/2 md:a1p/12 lg:a1T/12 xl:a1W/12">
                <div class="a1U">
                    <h3 class="a1X aE a1Y a1K a1t dark:aI">Get in touch</h3>
                    <div class="a23">
                        <div>
                            <p class="aE aF aG">Toll Free Customer Care</p>
                            <a href="tel:+(1) 123 456 7890" class="aE aF a1t hover:aH dark:aI dark:hover:aH">+(1) 123 456 7890</a>
                        </div>
                        <div>
                            <p class="aE aF aG">Need live support?</p>
                            <a href="cdn-cgi/l/email-protection.html#3a494f4a4a55484e7a5e55575b535414595557" class="aE aF a1t hover:aH dark:aI dark:hover:aH"><span class="__cf_email__" data-cfemail="0b787e7b7b64797f4b6f64666a626525686466">[email&#160;protected]</span></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="a4 a1v sm:a1S/2 md:a1p/12 lg:a1p/12 xl:a1T/12">
                <div class="a1U">
                    <h3 class="a1X aE a1Y a1K a1t dark:aI">Newsletter</h3>
                    <p class="a1V aE aF aG">Subscribe to receive future updates</p>
                    <form class="ac">
            ...
            <div class="a1R a5 a6 a2e md:a2f">
                <div class="a4 a1v md:a1S/2 lg:a1W/3">
                    <div class="a1I a5 a9 am a12 a1x aV dark:a1z[#2E333D] md:a2g md:as md:a2h md:a2i">
                        <a href="javascript:void(0)" class="aE aF aG hover:aH">English</a>
                        <a href="javascript:void(0)" class="aE aF aG hover:aH">Privacy Policy</a>
                        <a href="javascript:void(0)" class="aE aF aG hover:aH">Support</a>
                    </div>
                </div>
                <div class="a4 a1v md:a1S/2 lg:a1S/3">
                    <div>
                        <p class="az aE aF aG lg:a2j">© 2025 Startup. All rights reserved</p>
                    </div>
                </div>
            </div>
        </div>
