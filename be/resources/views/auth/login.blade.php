...
@section('content')
    ...
    <div class="layout">
        <div class="intro">
            <p class="eyebrow"><span class="dash"></span>Welcome Back</p>
            <h1>Align your breath,<br><em>body</em>, and soul.</h1>
                ...
                <div class="feature">
                    <div class="icon-wrap">
                        <svg width="84" height="84" viewBox="0 0 84 84" fill="none">
                            <path d="M12 46c-3-14 8-28 24-27 15 1 24 13 22 26-2 12-13 20-26 19-12-1-18-9-20-18z"
                                fill="#8a9a7e" opacity="0.16" />
                            <circle cx="63" cy="20" r="4" fill="#b96a4b" opacity="0.35" />
                            <rect x="30" y="24" width="20" height="34" rx="4" fill="#fff" stroke="#2b3d2f"
                                stroke-width="1.6" />
                            <rect x="34" y="18" width="12" height="8" rx="2" fill="#b96a4b" />
                            <line x1="34" y1="34" x2="46" y2="34" stroke="#8a9a7e"
                                stroke-width="1.6" stroke-linecap="round" />
                            <line x1="34" y1="40" x2="46" y2="40" stroke="#8a9a7e"
                                stroke-width="1.6" stroke-linecap="round" />
                            <line x1="34" y1="46" x2="42" y2="46" stroke="#8a9a7e"
                                stroke-width="1.6" stroke-linecap="round" />
                            <circle cx="41" cy="53" r="3" fill="#b96a4b" />
                            <circle cx="20" cy="62" r="2" fill="#2b3d2f" opacity="0.3" />
                        </svg>
                    </div>
                   <h3>Class Schedule & Booking</h3> 
                   <p>Choose from Alignment, Vinyasa, FeetUp, and more—whenever it works for you.</p>
                </div>
                <div class="feature">
                    <div class="icon-wrap">
                        <svg width="84" height="84" viewBox="0 0 84 84" fill="none">
                            <path d="M14 50c-4-15 7-30 26-29 16 1 25 14 22 27-3 13-15 21-28 20-13-1-18-9-20-18z"
                                fill="#b96a4b" opacity="0.14" />
                            ...
                            <path d="M28 46c-5 3-7 8-6 13" stroke="#2b3d2f" stroke-width="2" stroke-linecap="round"
                                fill="none" />
                            <path d="M56 46c5 3 7 8 6 13" stroke="#2b3d2f" stroke-width="2" stroke-linecap="round"
                                fill="none" />
                            <path d="M34 20c2-4 6-6 8-6s6 2 8 6" stroke="#8a9a7e" stroke-width="1.8" stroke-linecap="round"
                                fill="none" />
                        </svg>
                    </div>
                    <h3>Experienced Instructors</h3> 
                    <p>Practice with certified instructors who guide you with care, expertise, and intention.</p>
                </div>
                <div class="feature">
                    <div class="icon-wrap">
                        <svg width="84" height="84" viewBox="0 0 84 84" fill="none">
                            <path d="M13 47c-3-15 9-29 25-28 16 1 24 14 22 27-2 12-14 20-27 19-12-1-17-9-20-18z"
                                fill="#2b3d2f" opacity="0.1" />
                            <line x1="24" y1="60" x2="60" y2="60" stroke="#2b3d2f"
                            ...
                            <path d="M28 30l7 5 8-9 9 5" stroke="#b96a4b" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" fill="none" />
                        </svg>
                    </div>
                    <h3>Track Your Progress</h3> 
                    <p>Keep track of your attendance and celebrate your progress as your practice evolves.</p>
                </div>
                <div class="feature">
                    <div class="icon-wrap">
                        <svg width="84" height="84" viewBox="0 0 84 84" fill="none">
                            <path d="M15 49c-4-15 8-29 25-28 16 1 24 14 21 27-3 12-14 20-27 19-12-1-16-9-19-18z"
                                fill="#8a9a7e" opacity="0.16" />
                    ...
                    <h3>The YogaRoots Community</h3> 
                    <p>Connect with fellow practitioners and grow together in a warm, welcoming community.</p>
                </div>
            </div>

            <div class="breath-wrap">
                <div class="breath-circle"></div>
                <span>Take a slow, mindful breath.<br>You’re exactly where you need to be.</span>
            </div>
        </div>
        ...
        <div class="login-card">
            ...
            <form method="POST" id="loginForm" action="{{ route('login') }}">
                ...
                <button type="submit" class="btn-primary block" id="lanjutBtn">Sign in</button>
                ...
                <div class="card-footer">
                    <span>Begin your wellness journey with <b>YogaRoots</b></span>
                </div>
