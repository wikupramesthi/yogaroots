<!-- Modals add menu -->
<div id="modal-form-add-specializations" class="modal fade modal-form-specializations" tabindex="-1"
    aria-labelledby="modal-form-add-specializations-label" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="modal-form" action="{{ route('specializations.store') }}" method="post">
                @csrf
