            ...
            <div class="row align-items-center position-relative">
                <div class="col-lg-9">
                    <div class="badge bg-white bg-opacity-25 mb-2 px-3 py-2 rounded-pill">
                        {{ now()->translatedFormat('l, j F Y') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @forelse($upcomingClasses as $schedule)
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                {{-- Instructor Photo --}}
                                <div class="avatar-circle lg overflow-hidden flex-shrink-0">
                                    <img src="{{ $instructor?->avatar
                                        ...
                                        alt="{{ $instructor?->name ?? 'Instructor' }}" class="w-100 h-100 object-fit-cover">
                                </div>
