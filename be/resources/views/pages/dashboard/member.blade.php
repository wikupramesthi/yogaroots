...
<div class="container-fluid pb-5">
    ...
    <div class="hero-panel mb-4">
        <div class="row align-items-center position-relative">
            <div class="col-lg-9">
                <div class="badge bg-white bg-opacity-25 mb-2 px-3 py-2 rounded-pill">
                    {{ now()->translatedFormat('l, j F Y') }}
                </div>
                <h3 class="fw-bold text-white mb-1">Hi, {{ auth()->user()->name }} 🌸</h3>
                <p class="text-white-50 mb-0">
                    Discover useful tips and interesting information today. There are plenty of new things to learn and
                    explore.
                </p>
            </div>
            <div class="col-lg-3 text-lg-end mt-3 mt-lg-0" style="position: relative;z-index: 1;">
                <a href="{{ route('packages.member') }}" class="btn btn-light fw-bold px-4"><i
                        class="bi bi-calendar-check me-1"></i> Select Your Plan</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="py-3 border-bottom">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="fw-bold" style="color:var(--bs-heading-color);">
                                    {{ $class?->name ?? 'Class unavailable' }}

                                    @if ($class?->level)
                                    — Level {{ ucfirst($class->level) }}
                                    @endif
                                </div>
                        ...
                        <a href="#" class="btn btn-primary w-100 d-md-none mt-3">
                            View Class
                        </a>
                    </div>
                    ...
                    <div class="text-center py-5">
                        <div class="mb-3">
                            <i class="bi bi-calendar2-week"
                                style="font-size: 2rem; color: var(--bs-secondary-color);"></i>
                        </div>

                        <h6 class="fw-semibold mb-1" style="color: var(--bs-heading-color);">
                            No Upcoming Classes
                        </h6>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-4" id="progress">
            <div class="card border-0 h-100">
                ...
                <!-- Modal Event 1 -->
                @foreach ($events as $event)
                <div class="modal fade" id="eventModal{{ $event->uuid }}" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <img src="{{ asset('storage/' . $event->gambar) }}" class="img-fluid"
                                alt="{{ $event->judul }}" style="max-height: 300px; object-fit: cover;">
                            @endif
